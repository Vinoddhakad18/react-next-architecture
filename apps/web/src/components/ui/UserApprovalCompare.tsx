...
import { buildApprovalDataRows } from '@/lib/users/approvalDataDisplay';

export interface UserApprovalCompareProps {
  previousData?: Record<string, unknown>;
  proposedData?: Record<string, unknown>;
  changedFields?: string[];
}

export function UserApprovalCompare({
  previousData,
  proposedData,
  changedFields,
}: UserApprovalCompareProps) {
